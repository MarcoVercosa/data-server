...
import storeSearchBarHeaderComponent from "./reducers/searchBarHeaderComponent"
import storeDataSearchServer from "./reducers/dataSearchServer"

const reducer = combineReducers({
    //importa somente o estado do reducer, não os reducers em si
    storeSearchBarHeaderComponent,
    storeDataSearchServer
})
